...
public class ResourceSpeakerTest {
    ...
    public static WebArchive deploy() {
        ...
        final File jacksonCoreLib = Maven.resolver().resolve("com.fasterxml.jackson.core:jackson-core:2.8.11").withoutTransitivity().asSingleFile();
        final File jacksonDatabindLib = Maven.resolver().resolve("com.fasterxml.jackson.core:jackson-databind:2.8.11.2").withoutTransitivity().asSingleFile();
        final File jacksonAnnotationsLib = Maven.resolver().resolve("com.fasterxml.jackson.core:jackson-annotations:2.8.11").withoutTransitivity().asSingleFile();
